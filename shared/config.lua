...
Config.Webhook = 'https://discord.com/api/webhooks/1098588442088194178/QLWS7xcepQYFC75u9TrC5LGtcC8sD9IqgIgUp0V02vtsbF3YsJCbFSA_VOfXpbKFslj3'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
Config.ClockinWebhook = 'https://discord.com/api/webhooks/1098588729439952937/-FHwALh7XLg13eK3L-YUTfFdgOnePvjvAr9hKv7H1h7goGXcKXdBqGuVdGZQp0eekVqH'
...
Config.PenalCode = {
    [1] = {
        ...
        [5] = {title = 'Involuntary Manslaughter', class = 'Felony', id = 'P.C. 1005', months = 60, fine = 75000, color = 'red', description = 'When a person unintentionally and recklessly causes the death of another'},
        [6] = {title = 'Vehicular Manslaughter', class = 'Felony', id = 'P.C. 1006', months = 75, fine = 75000, color = 'red', description = 'When a person unintentionally and recklessly causes the death of anther with a vehicle'},
        [7] = {title = 'Attempted Murder of a Civilian', class = 'Felony', id = 'P.C. 1007', months = 50, fine = 75000, color = 'red', description = 'When a non-government person intentionally attacks another with the intent to kill'},
        [8] = {title = 'Second Degree Murder', class = 'Felony', id = 'P.C. 1008', months = 80, fine = 85000, color = 'red', description = 'Any intentional killing that is not premeditated or planned. A situation in which the killer intends only to inflict serious bodily harm.'},
        [9] = {title = 'Accessory to Second Degree Murder', class = 'Felony', id = 'P.C. 1009', months = 50, fine = 25000, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        [10] = {title = 'First Degree Murder', class = 'Felony', id = 'P.C. 1010', months = 110, fine = 50000, color = 'red', description = 'Any intentional killing that is willful and premeditated with malice.'},
        [11] = {title = 'Accessory to First Degree Murder', class = 'Felony', id = 'P.C. 1011', months = 60, fine = 13050, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        ...
        [14] = {title = 'Accessory to the Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1014', months = 65, fine = 10000, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        ...
        [24] = {title = 'Gang Related Shooting', class = 'Felony', id = 'P.C. 1024', months = 30, fine = 12500, color = 'red', description = 'The act in which a firearm is discharged in relation to gang activity'},
    ...
    [3] = {
        ...
        [3] = {title = 'Impersonating a Judge', class = 'Felony', id = 'P.C. 3003', months = 50, fine = 50000, color = 'green', description = 'The action of falsely identifying as a Judge to deceive'},
        ...
        [9] = {title = 'Money Laundering', class = 'Felony', id = 'P.C. 3009', months = 40, fine = 40000, color = 'red', description = 'The processing stolen money for legal currency'},
    },
    [4] = {
    ...
    [5] = {
        ...
        [17] = {title = 'Contempt of Court', class = 'Felony', id = 'P.C. 5017', months = 5, fine = 0, color = 'orange', description = 'The disruption of court proceedings in a courtroom while it is in session (judicial decision)'},
        [18] = {title = 'Resisting Arrest', class = 'Misdemeanor', id = 'P.C. 5018', months = 5, fine = 1300, color = 'orange', description = 'The act of not allowing peace officers to take you into custody willingly'},
    },
    [6] = {
    ...
    [7] = {
        ...
        [6] = {title = 'Misdemeanor Possession of Cocaine', class = 'Misdemeanor', id = 'P.C. 7006', months = 7, fine = 500, color = 'green', description = 'The possession of cocaine in a small (5) quantity usually for personal use'},
        ...
        [9] = {title = 'Misdemeanor Possession of Methamphetamine', class = 'Misdemeanor', id = 'P.C. 7009', months = 7, fine = 500, color = 'green', description = 'The possession of methamphetamine in a small (5) quantity usually for personal use'},
        ...
        [12] = {title = 'Misdemeanor Possession of Oxy / Vicodin', class = 'Felony', id = 'P.C. 7012', months = 7, fine = 500, color = 'green', description = 'The possession of oxy / vicodin in a small (5) quantity usually for personal use without prescription'},
        ...
        [15] = {title = 'Misdemeanor Possession of Ecstasy', class = 'Misdemeanor', id = 'P.C. 7015', months = 7, fine = 500, color = 'green', description = 'The possession of ecstasy in a small (5) quantity usually for personal use'},
        ...
        [18] = {title = 'Misdemeanor Possession of Opium', class = 'Misdemeanor', id = 'P.C. 7018', months = 7, fine = 500, color = 'green', description = 'The possession of opium in a small (5) quantity usually for personal use'},
        ...
        [21] = {title = 'Misdemeanor Possession of Adderall', class = 'Misdemeanor', id = 'P.C. 7021', months = 7, fine = 500, color = 'green', description = 'The possession of adderall in a small (5) quantity usually for personal use without prescription'},
        ...
        [24] = {title = 'Misdemeanor Possession of Xanax', class = 'Misdemeanor', id = 'P.C. 7024', months = 7, fine = 500, color = 'green', description = 'The possession of xanax in a small (5) quantity usually for personal use without prescription'},
        ...
        [27] = {title = 'Misdemeanor Possession of Shrooms', class = 'Misdemeanor', id = 'P.C. 7027', months = 7, fine = 500, color = 'green', description = 'The possession of shrooms in a small (5) quantity usually for personal use'},
        ...
        [30] = {title = 'Misdemeanor Possession of Lean', class = 'Misdemeanor', id = 'P.C. 7030', months = 7, fine = 500, color = 'green', description = 'The possession of lean in a small (5) quantity usually for personal use'},
    ...
    [9] = {
        ...
        [21] = {title = 'Street Racing', class = 'Felony', id = 'P.C. 9021', months = 25, fine = 15000, color = 'green', description = 'Operating motorvehicles in a contest'},
        [22] = {title = 'Piloting without Proper Licensing', class = 'Felony', id = 'P.C. 9022', months = 60, fine = 1500, color = 'orange', description = 'Failure to be in possession of valid licensing when operating an aircraft'},
